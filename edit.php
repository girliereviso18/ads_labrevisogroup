...
if (isset($_POST["id"]) && !empty($_POST["id"])) {
    ...
    if (empty($id_error_err) && empty($name_error) &&
        empty($description_error) && empty($classification_error)) {
          ...
          $sql = "UPDATE users SET name = '$name', description = '$description', classification= '$classification' WHERE id='$id'";
                ...
                <div class="col-md-12">
                    ...
                    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                      <input type="hidden" name="id" value="<?php echo $id; ?>"/>
                        ...
                        <div class="form-group <?php echo (!empty($classfication_error)) ? 'has-error' : ''; ?>">
